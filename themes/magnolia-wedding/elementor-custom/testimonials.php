...
class Wedding_Testimonial_Carousel extends Widget_Base {
	...
	public function get_title() {
		return __( 'MF Testimonial Carousel', 'magnolia-wedding' );
	}
	...
	protected function _register_controls() {
		$this->add_control(
			...
			[
				'label' => __( 'MF Overlapping Image', 'magnolia-wedding' ),
		...
		$this->add_control(
			'testimonial_image1',
			[
				'label'   => __( 'Testimonial Image 1', 'magnolia-wedding' ),
		...
		$this->add_control(
			'testimonial_job1',
			[
				'label'   => __( 'Testimonial Job 1', 'magnolia-wedding' ),
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Testimonial Content 1', 'magnolia-wedding' ),
				'type'    => Controls_Manager::TEXT,
				'section' => 'section_mf_testimonials'
			]
		);
		...
		$this->add_control(
			'testimonial_image2',
			[
				'label'   => __( 'Testimonial Image 2', 'magnolia-wedding' ),
				'type'    => Controls_Manager::MEDIA,
				'section' => 'section_mf_testimonials'
			]
		);
		...
		$this->add_control(
			'testimonial_job2',
			[
				'label'   => __( 'Testimonial Job 2', 'magnolia-wedding' ),
				'type'    => Controls_Manager::TEXT,
				'section' => 'section_mf_testimonials'
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Testimonial Content 2', 'magnolia-wedding' ),
				'type'    => Controls_Manager::TEXT,
				'section' => 'section_mf_testimonials'
			]
		);
		...
		$this->add_control(
			'testimonial_image3',
			[
				'label'   => __( 'Testimonial Image 3', 'magnolia-wedding' ),
				'type'    => Controls_Manager::MEDIA,
				'section' => 'section_mf_testimonials'
			]
		);
		...
		$this->add_control(
			'testimonial_job3',
			[
				'label'   => __( 'Testimonial Job 3', 'magnolia-wedding' ),
				'type'    => Controls_Manager::TEXT,
				'section' => 'section_mf_testimonials'
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Testimonial Content 3', 'magnolia-wedding' ),
				'type'    => Controls_Manager::TEXT,
				'section' => 'section_mf_testimonials'
			]
		);
