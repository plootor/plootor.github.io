...
class MilleFiori_Header_Slider_Carousel extends Widget_Base {
	...
	protected function render( $instance = [] ) {
		...
		$content = '<div class="header-slider slick-carousel"'
		           . ' data-slick=\'{"arrows": false, "fade": true, "infinite": true, "autoplay": true, "autoplaySpeed": 40000}\'>' . PHP_EOL;
		while ( true ) {
			...
			$content .= '<div class="hero" style="background-image: url(' . $image['url'] . ')">' . PHP_EOL
			            ...
			            . ( $sub_title ? '<h2 class="sub-title" data-animation="fadeInLeft" data-delay="0.5s">' . $sub_title . '</h2>' . PHP_EOL : '' )
