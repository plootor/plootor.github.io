...
<header class="masthead" style="height: <?php echo theme_get_option( 'page_header_slider_height', '73' ) ?>%;">
  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="carousel-item item active" style="background-image: url('<?php echo theme_get_option( 'theme_slide1_image', '' )?>')"></div>
      <div class="carousel-item item" style="background-image: url('<?php echo theme_get_option( 'theme_slide2_image', '' )?>')"></div>
      <div class="carousel-item item" style="background-image: url('<?php echo theme_get_option( 'theme_slide3_image', '' )?>')"></div>
      <div class="carousel-item item" style="background-image: url('<?php echo theme_get_option( 'theme_slide4_image', '' )?>')"></div>
    </div>
