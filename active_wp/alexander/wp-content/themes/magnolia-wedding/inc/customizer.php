...
function wedding_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		array(
			'title'       => __( 'Page Loading and Animation Settings', 'magnolia-wedding' ),
			'priority'    => 30,
			'description' => __( 'This setting will allow you to enable/disable loading page animation(Disable when edit page with Elementor) and fade animation.', 'magnolia-wedding' )
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'wedding_loading', array(
				'label'             => __( 'Loading Page Animation setup', 'magnolia-wedding' ),
				'section'           => 'wedding_animation_options',
				'settings'          => 'wedding_loading',
				'type'              => 'select',
				'sanitize_callback' => 'theme_slug_sanitize_select',
				'choices'           => array(
					'enable'  => __( 'Enable', 'magnolia-wedding' ),
					'disable' => __( 'Disable', 'magnolia-wedding' ),
				),
				'priority'          => '10',
			)
		) );
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			$wp_customize,
			'wedding_fade', array(
				'label'             => __( 'FadeIn Animation Setup', 'magnolia-wedding' ),
				'section'           => 'wedding_animation_options',
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'wedding_fade_left', array(
				'label'             => __( 'FadeIn Left Animation Setup', 'magnolia-wedding' ),
				'section'           => 'wedding_animation_options',
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'wedding_fade_right', array(
				'label'             => __( 'FadeIn Right Animation Setup', 'magnolia-wedding' ),
				'section'           => 'wedding_animation_options',
