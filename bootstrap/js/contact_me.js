...
$(function() {
    $("#mc-embedded-subscribe-form input").jqBootstrapValidation({
        preventSubmit: true,
        submitError: function($form, event, errors) { console.log('inside error');
            // additional error messages or events
        },
        submitSuccess: function($form, event) { console.log('inside success');
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    $('#subscribe-success > .alert-success')
                        .append("<strong>Your subscribe message has been sent. </strong>");
                    $('#subscribe-success > .alert-success')
                        .append('</div>');
