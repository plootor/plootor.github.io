...
class MileFiori_Customizer {
  ...
  public static function Sections( $wp_customize ) {
     ...
     */
    $wp_customize->add_section( 'millefiori_sort_section', [
        'title'       => __( 'Sections Sorting', 'mille-fiori' ),
        'description' => __( 'Allows you to sorting of sections for millefiori Theme.', 'mille-fiori' ),
        //Descriptive tooltip
        'panel'       => '',
        'priority'    => '13',
        'capability'  => 'edit_theme_options'
     ...
     * @return array
     */
    $wp_customize->add_panel( 'latestpost_setting_panel', [
        'title'       => __( 'Latest Post Section', 'mille-fiori' ),
        'description' => __( 'Allows you to...', 'mille-fiori' ),
        'priority'    => '2',
        'capability'  => 'edit_theme_options'
      ]
    );
     ...
     */
    $wp_customize->add_section( 'latestpost_heading_setting_section', [
        'title'       => __( 'Heading Settings', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Latest Post headings.', 'mille-fiori' ), //Descriptive tooltip
    ...
    $wp_customize->add_section( 'latestpost_content_setting_section', [
        'title'       => __( 'Content Settings', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Latest Post content.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'latestpost_setting_panel',
        'priority'    => '10',
        'capability'  => 'edit_theme_options'
      ]
     ...
     * @return array
     */
    $wp_customize->add_panel( 'story_setting_panel', [
        'title'       => __( 'Our Story Section', 'mille-fiori' ),
        'description' => __( 'Allows you to...', 'mille-fiori' ), //Descriptive tooltip
        'priority'    => '3',
        'capability'  => 'edit_theme_options'
      ]
    );
     ...
     */
    $wp_customize->add_section( 'story_heading_setting_section', [
        'title'       => __( 'Heading Settings', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Header text for Our Story Section.', 'mille-fiori' ),
        //Descriptive tooltip
    ...
    $wp_customize->add_section( 'story_setting_section', [
        'title'       => __( 'Content Settings', 'mille-fiori' ),
        'description' => __( 'Allows you to set content.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'story_setting_panel',
        'priority'    => '11',
        'capability'  => 'edit_theme_options'
      ]
     ...
     * @return array
     */
    $wp_customize->add_panel( 'our_team_setting_panel', [
        'title'       => __( 'Team Section', 'mille-fiori' ),
        'description' => __( 'Allows you to setup team section', 'mille-fiori' ), //Descriptive tooltip
        'priority'    => '4',
        'capability'  => 'edit_theme_options'
      ]
    );
     ...
     * Our Story heading section
     */
    $wp_customize->add_section( 'team_left_content_setting_section', [
        'title'       => __( 'Team title and content', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Header and text for Team Section.', 'mille-fiori' ),
        //Descriptive tooltip
    ...
    $wp_customize->add_section( 'team_member1_setting_section', [
        'title'       => __( 'Team Member #1', 'mille-fiori' ),
        'description' => __( 'Allows you to set content.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'our_team_setting_panel',
        'priority'    => '2',
        'capability'  => 'edit_theme_options'
    ...
    $wp_customize->add_section( 'team_member2_setting_section', [
        'title'       => __( 'Team Member #2', 'mille-fiori' ),
        'description' => __( 'Allows you to set content.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'our_team_setting_panel',
        'priority'    => '3',
        'capability'  => 'edit_theme_options'
    ...
    $wp_customize->add_section( 'team_member3_setting_section', [
        'title'       => __( 'Team Member #3', 'mille-fiori' ),
        'description' => __( 'Allows you to set content.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'our_team_setting_panel',
        'priority'    => '4',
        'capability'  => 'edit_theme_options'
    ...
    $wp_customize->add_section( 'team_member4_setting_section', [
        'title'       => __( 'Team Member #4', 'mille-fiori' ),
        'description' => __( 'Allows you to set content.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'our_team_setting_panel',
        'priority'    => '5',
        'capability'  => 'edit_theme_options'
     ...
     * @return array
     */
    $wp_customize->add_panel( 'quote_setting_panel', [
        'title'       => __( 'Quote Section', 'mille-fiori' ),
        'description' => __( 'Allows you to setup quote text', 'mille-fiori' ), //Descriptive tooltip
        'priority'    => '5',
        'capability'  => 'edit_theme_options'
      ]
    );
     ...
     * Our Story heading section
     */
    $wp_customize->add_section( 'quote_setting_section', [
        'title'       => __( 'Quote Content', 'mille-fiori' ),
        'description' => __( 'Allows you to set up quote text', 'mille-fiori' ), //Descriptive tooltip
     ...
     * @return array
     */
    $wp_customize->add_panel( 'services_setting_panel', [
        'title'       => __( 'Service Section', 'mille-fiori' ),
        'description' => __( 'Allows you to setup quote text', 'mille-fiori' ), //Descriptive tooltip
        'priority'    => '6',
        'capability'  => 'edit_theme_options'
      ]
     ...
     */
    $wp_customize->add_section( 'services_section_heading_section', [
        'title'       => __( 'Section Heading', 'mille-fiori' ),
        'description' => __( 'Allows you to set section heading', 'mille-fiori' ), //Descriptive tooltip
    ...
    $wp_customize->add_section( 'services_images_setting_section', [
        'title'       => __( 'Service Images', 'mille-fiori' ),
        'description' => __( 'Allows you to set up images', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'services_setting_panel',
        'priority'    => '1',
        'capability'  => 'edit_theme_options'
      ]
     ...
     */
    $wp_customize->add_section( 'services_element1_setting_section', [
        'title'       => __( 'Service #1 Element', 'mille-fiori' ),
        'description' => __( 'Allows you to set up element settings', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'services_setting_panel',
        'priority'    => '1',
        'capability'  => 'edit_theme_options'
      ]
     ...
     * Services Element section
     */
    $wp_customize->add_section( 'services_element2_setting_section', [
        'title'       => __( 'Service #2 Element', 'mille-fiori' ),
        'description' => __( 'Allows you to set up element settings', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'services_setting_panel',
        'priority'    => '1',
        'capability'  => 'edit_theme_options'
     ...
     * Services Element section
     */
    $wp_customize->add_section( 'services_element3_setting_section', [
        'title'       => __( 'Service #3 Element', 'mille-fiori' ),
        'description' => __( 'Allows you to set up element settings', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'services_setting_panel',
        'priority'    => '1',
        'capability'  => 'edit_theme_options'
     ...
     * Services Element section
     */
    $wp_customize->add_section( 'services_element4_setting_section', [
        'title'       => __( 'Service #4 Element', 'mille-fiori' ),
        'description' => __( 'Allows you to set up element settings', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'services_setting_panel',
        'priority'    => '1',
        'capability'  => 'edit_theme_options'
     ...
     * @return array
     */
    $wp_customize->add_panel( 'subscribe_setting_panel', [
        'title'       => __( 'Subscribe Section', 'mille-fiori' ),
        'description' => __( 'Allows you to set up subscribe section header', 'mille-fiori' ), //Descriptive tooltip
        'priority'    => '7',
        'capability'  => 'edit_theme_options'
      ]
    );
     ...
     * Subscribe section
     */
    $wp_customize->add_section( 'subscribe_setting_section', [
        'title'       => __( 'Subscribe Header', 'mille-fiori' ),
        'description' => __( 'set Subscribe Header', 'mille-fiori' ), //Descriptive tooltip
     ...
     * @return array
     */
    $wp_customize->add_panel( 'partners_setting_panel', [
        'title'       => __( 'Partners Section', 'mille-fiori' ),
        'description' => __( 'Allows you to set up partner section elements', 'mille-fiori' ), //Descriptive tooltip
        'priority'    => '9',
        'capability'  => 'edit_theme_options'
      ]
    );
     ...
     * Partners section
     */
    $wp_customize->add_section( 'partners_setting_section', [
        'title'       => __( 'Partners Settings', 'mille-fiori' ),
        'description' => __( 'set partner section', 'mille-fiori' ), //Descriptive tooltip
    ...
    $wp_customize->add_panel( 'testimonial_setting_panel', [
        'title'       => __( 'Testimonials Section', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Testimonials Section.', 'mille-fiori' ), //Descriptive tooltip
        'priority'    => '10',
        'capability'  => 'edit_theme_options'
      ]
    );
     ...
     */
    $wp_customize->add_section( 'testimonial_heading_setting_section', [
        'title'       => __( 'Heading Settings', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Testimonials section headings.', 'mille-fiori' ),
        //Descriptive tooltip
    ...
    $wp_customize->add_section( 'testimonial_box1_setting_section', [
        'title'       => __( 'Testimonial #1', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Testimonials#1 section content for millefiori Theme.', 'mille-fiori' ),
        //Descriptive tooltip
        'panel'       => 'testimonial_setting_panel',
        'priority'    => '11',
        'capability'  => 'edit_theme_options'
    ...
    $wp_customize->add_section( 'testimonial_box2_setting_section', [
        'title'       => __( 'Testimonial #2', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Testimonials#2 section content for millefiori Theme.', 'mille-fiori' ),
        //Descriptive tooltip
        'panel'       => 'testimonial_setting_panel',
        'priority'    => '12',
        'capability'  => 'edit_theme_options'
    ...
    $wp_customize->add_section( 'testimonial_box3_setting_section', [
        'title'       => __( 'Testimonial #3', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Testimonials#3 section content for millefiori Theme.', 'mille-fiori' ),
        //Descriptive tooltip
        'panel'       => 'testimonial_setting_panel',
        'priority'    => '13',
        'capability'  => 'edit_theme_options'
     ...
     * Testimonials box#3
     */
    $wp_customize->add_section( 'testimonial_box4_setting_section', [
        'title'       => __( 'Testimonial #4', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Testimonials#3 section content for millefiori Theme.', 'mille-fiori' ),
        //Descriptive tooltip
        'panel'       => 'testimonial_setting_panel',
        'priority'    => '14',
     ...
     * Testimonials section panel
     */
    $wp_customize->add_panel( 'contactpage_setting_panel', [
        'title'       => __( 'Contact Section', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Contact section.', 'mille-fiori' ), //Descriptive tooltip
        'priority'    => '11',
        'capability'  => 'edit_theme_options'
      ]
    );
     ...
     * Contact Section
     */
    $wp_customize->add_section( 'contact_setting_section', [
        'title'       => __( 'Contact Settings', 'mille-fiori' ),
     ...
     * @return array
     */
    $wp_customize->add_panel( 'portfolio_setting_panel', [
        'title'       => __( 'Portfolio Section', 'mille-fiori' ),
        'description' => __( 'Allows you to set up portfolio section.', 'mille-fiori' ), //Descriptive tooltip
        'priority'    => '8',
        'capability'  => 'edit_theme_options'
      ]
    );
     ...
     */
    $wp_customize->add_section( 'portfolio_heading_setting_section', [
        'title'       => __( 'Heading Settings', 'mille-fiori' ),
        'description' => __( 'Allows you to set up portfolio headings.', 'mille-fiori' ), //Descriptive tooltip
     ...
     */
    $wp_customize->add_section( 'portfolio_filter_setting_section', [
        'title'       => __( 'Portfolio Filtering Settings', 'mille-fiori' ),
        'description' => __( 'Allows you to set up portfolio filters.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'portfolio_setting_panel',
        'priority'    => '2',
        'capability'  => 'edit_theme_options'
      ]
     ...
     * Portfolio Box Main
     */
    $wp_customize->add_section( 'portfolio_box_main', [
        'title'       => __( 'Portfolio Text Box', 'mille-fiori' ),
        'description' => __( 'Allows you to set up portfolio text box', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'portfolio_setting_panel',
        'priority'    => '11',
        'capability'  => 'edit_theme_options'
      ]
     ...
     * Portfolio Box#1
     */
    $wp_customize->add_section( 'portfolio_box1', [
        'title'       => __( 'Portfolio Box #1', 'mille-fiori' ),
        'description' => __( 'Allows you to set up portfolio box #1.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'portfolio_setting_panel',
        'priority'    => '11',
        'capability'  => 'edit_theme_options'
      ]
     ...
     * Portfolio Box#2
     */
    $wp_customize->add_section( 'portfolio_box2', [
        'title'       => __( 'Portfolio Box #2', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Portfolio box #2.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'portfolio_setting_panel',
        'priority'    => '12',
        'capability'  => 'edit_theme_options'
      ]
     ...
     * Portfolio Box#3
     */
    $wp_customize->add_section( 'portfolio_box3', [
        'title'       => __( 'Portfolio Box #3', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Portfolio box #3.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'portfolio_setting_panel',
        'priority'    => '13',
        'capability'  => 'edit_theme_options'
      ]
     ...
     * Portfolio Box#4
     */
    $wp_customize->add_section( 'portfolio_box4', [
        'title'       => __( 'Portfolio Box #4', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Portfolio box #4.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'portfolio_setting_panel',
        'priority'    => '13',
        'capability'  => 'edit_theme_options'
      ]
     ...
     * Portfolio Box#5
     */
    $wp_customize->add_section( 'portfolio_box5', [
        'title'       => __( 'Portfolio Box #5', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Portfolio box #5.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'portfolio_setting_panel',
        'priority'    => '13',
        'capability'  => 'edit_theme_options'
      ]
     ...
     * Portfolio Box#6
     */
    $wp_customize->add_section( 'portfolio_box6', [
        'title'       => __( 'Portfolio Box #6', 'mille-fiori' ),
        'description' => __( 'Allows you to set up Portfolio box #6.', 'mille-fiori' ), //Descriptive tooltip
        'panel'       => 'portfolio_setting_panel',
        'priority'    => '13',
        'capability'  => 'edit_theme_options'
      ]
